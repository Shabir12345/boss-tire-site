  ...
  return (
    <>
      ...
      <PageHeader
        ...
        showCall
        price={{ label: "Muffler", amount: `From ${formatPrice(muffler ? requirePrice(muffler) : 160)}`, note: "varies by vehicle" }}
      ...
      <FaqSection faqs={FAQS} heading="Muffler & exhaust FAQ" />

      <LocalTrust service="muffler-repair" />
