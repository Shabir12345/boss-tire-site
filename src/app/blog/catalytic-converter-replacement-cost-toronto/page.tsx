  ...
  return (
    <>
        ...
        <div className="gutter-safe mx-auto max-w-3xl py-16 sm:py-20">
          <div className="space-y-6 text-lg leading-relaxed text-[var(--color-body)]">
            <p>
              ...
              anyone who gives you one over the phone without seeing the car is guessing. The real cost turns on
              whether your converter is OEM or aftermarket, how many your vehicle has, where it sits in the exhaust
              system, and whether the pipe, sensors or hangers around it got damaged too, whether from a failure or
              a theft. What we can do here is walk through exactly what drives that number, so a call to the shop
              gets you a real figure instead of a guess.
            </p>
            ...
            <p>
              ...
              palladium and rhodium, the precious metals that trigger the chemical reaction cleaning up exhaust
              gases. That is the entire reason theft became a problem: a part worth relatively little to you as a
              spare has real scrap value to whoever cuts it out. One thing worth being clear on is that the scrap
              value of the metal has nothing to do with what a replacement part costs at the counter. One is a
              commodity price, the other is a manufactured part plus labour, and the two numbers aren't related.
            ...
            <p>
              ...
              the engine. It isn't a slow build-up over weeks. It's a sudden, unmistakable roar from the first
              turn of the key. If that's what you're hearing, you already know the answer without needing a
              diagnosis.
            </p>
            <p>
              ...
              which bank of the engine it's on. That code is a strong pointer toward the converter, but it isn't
              proof by itself: a leak upstream of the sensor, or a failing oxygen sensor giving a bad reading, can
              trigger the same code without the converter being the problem at all. That's exactly why the code
            ...
            <p>
              A rattle is where people jump to the most expensive conclusion first, and it isn't always the right
              one. A loose heat shield, the thin metal panel that protects the underbody from exhaust heat, makes a
              very similar metallic rattle when a clip or bolt has worked loose, and it's a fraction of the cost to
              fix. A broken exhaust hanger lets the pipe sag and knock against the underbody over bumps, which can
              sound just as alarming and is also a much smaller job.
            </p>
            <p>
              The only way to tell them apart is to get the car up on a hoist and look. That diagnosis is exhaust
              work, not converter work, and it's priced accordingly. Exhaust repair at Boss Tire starts at{" "}
              {formatPrice(requirePrice(exhaust))}, before tax, which covers finding out whether you're looking at
            ...
            <p>
              ...
              your car up, look at exactly what's going on underneath, and tell you straight whether you're dealing
              with a converter, a pipe, a hanger or a sensor, and what that means for the job ahead. That's a more
              useful starting point than a number pulled from a search result for a car that isn't yours.
            </p>
            <p>
              Call the shop with the year, make and model, and describe what you're hearing or smelling, and we'll
              tell you what we actually find. See{" "}
      ...
      <CTABand
        ...
        sub="Call the shop and we'll tell you exactly what's underneath, converter, pipe or hanger, before anything gets quoted."
      />
    </>
  );
}
