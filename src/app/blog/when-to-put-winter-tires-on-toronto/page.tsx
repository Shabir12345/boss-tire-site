  ...
  return (
    <>
      ...
      <section className="bg-[var(--color-paper)]">
        <div className="gutter-safe mx-auto max-w-3xl py-16 sm:py-20">
          <div className="space-y-6 text-lg leading-relaxed text-[var(--color-body)]">
            <p>
              The honest answer isn't a date on the calendar — it's a temperature. Once daytime highs are
              sitting below roughly 7°C, all-season rubber stops doing what you think it does, snow or no snow.
              In Toronto that usually lands somewhere around mid-October, but the trigger is the thermometer,
              not the first flurry. Wait for snow on the ground and you've likely already been driving for
              weeks on tires that quietly gave up their grip on cold, dry pavement.
            </p>
            ...
            <p>
              ...
              stiffen once it drops below about 7°C. Stiffer rubber can't conform to the road the same way —
              it skates across small imperfections instead of gripping them.
            </p>
            <p>
            ...
            <p>
              Nobody plans to wait until the first storm — it just happens, because a calendar reminder is
              easy to ignore and a windshield full of snow is not. The problem is that the storm arrives after
              the temperature has already been below that 7°C line for weeks in most years, so the tires have
              already been underperforming the whole time you were driving on dry, cold pavement to get
              groceries or drop the kids off.
            </p>
            <h2 className="pt-4 font-display text-2xl font-bold uppercase tracking-wide text-[var(--color-heading)]">
            ...
            <p>
              ...
              climbs through that stretch and keeps climbing as the weather turns — it isn't spread evenly
              across the season. The earlier you book inside that window, the more say you have over which day
              and time works for you. Book later and you're choosing from whatever's left, on a schedule set by
              everyone else who waited for the same cold snap.
            </p>
            <p>
              ...
              Ontario does have is a lot of insurers who offer a discount to drivers running a proper winter
              set — the details vary by provider, so it's worth a call to your own insurer to ask what they
              offer before you assume there's nothing in it for you.
            </p>
            <p>
            ...
            <p>
              A seasonal changeover at Boss Tire is {formatPrice(requirePrice(changeover))}, before tax —
              tires inspected, mounted and balanced, pressures set, and everything torqued to spec while you
              wait. See the full{" "}
      ...
      <CTABand
        ...
        sub="Call the shop or book your seasonal swap before the rush hits — mounted, balanced and torqued the same day."
      />
    </>
  );
}
